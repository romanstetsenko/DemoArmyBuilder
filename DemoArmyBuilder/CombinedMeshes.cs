...
using XenkoByteSized;

namespace DemoArmyBuilder
{

    public class PoorMansMultiMesh : SyncScript
    {
        ...
        static public Mesh CreateMesh(VertexBufferBinding bufferBinding)
        {
        ...
        */
        ...
        private void UpdateMatrices()
        {
            ...
            {
                matrices.Add(transform.Value.WorldMatrix);
            }
